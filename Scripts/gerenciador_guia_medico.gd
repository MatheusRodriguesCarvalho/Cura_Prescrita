...
@onready var noticia_atual: RichTextLabel = $PainelPaginas/PaginaNoticias/DivRegras/NoticiaAtual
@onready var noticias_anteriores: RichTextLabel = $PainelPaginas/PaginaNoticias/DivRegras/Scroll/NoticiasAnteriores
...
func _popular_noticias() -> void:
	var atual := GerenciadorPacientes.noticia_do_dia(GerenciadorPacientes.fase_atual)
