...
@onready var botao_retornar: TextureButton = $FichaPaginas/ScrollContainer/VBoxContainer/HBoxContainer/Retornar
@onready var botao_excluir: TextureButton = $FichaPaginas/ScrollContainer/VBoxContainer/HBoxContainer/Excluir
